...
export default function AutomotiveProof() {
  ...
  const steps = t("landing.proof.steps", { returnObjects: true }) as Array<{ label: string; detail: string }>;
  const stats = t("landing.proof.stats", { returnObjects: true }) as Array<{ stat: string; desc: string }>;
